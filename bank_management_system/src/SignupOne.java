...
public class SignupOne extends JFrame implements ActionListener{
    long random;
    JTextField nameTextField, lnameTextField, dobTextField, emailTextField, addressTextField, cityTextField, stateTextField, zipTextField;
    JButton next;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if (name.equals("")){
                ...
                Conn c = new Conn();
                String query ="Insert into signup values('"+formno+"', '"+name+"','"+lname+"','"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"','"+city+"', '"+state+"', '"+zip+"')";
                c.s.executeUpdate(query);

                setVisible(false);
                new SignupTwo(formno).setVisible(true);
            }//he has zip then state
